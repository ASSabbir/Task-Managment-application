...
const Register = () => {
    const { handelSignup } = useContext(MainContext)
    ...
    return (
        <div className=" h-screen bg-color1 py-32 justify-center items-center flex">
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl text-white bg-color2 ">
                        <h1 className="text-4xl text- font-bold text-center">Register</h1>
                        <form onSubmit={handelSubmit} className="space-y-6">
                            <div className="space-y-1 text-sm">
                                <label className="block ">Email</label>
                                <input type="text" name="email" placeholder="email" className="w-full px-4 py-3 rounded-md  border-2 bg-gray-300 text-black  " />
                            </div>
                            <div className="space-y-1 text-sm">
                                <label className="block ">Password</label>
                                <input type="password" name="password" placeholder="Password" className="w-full border-2 px-4 py-3 rounded-md  bg-gray-300 text-black  " />
